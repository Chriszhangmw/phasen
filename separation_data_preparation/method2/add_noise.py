...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--clean_wav_list',
        type=str,
        default='../method2_data/paths/fixed_train.lst'
    )
    parser.add_argument(
        '--noise_wav_list',
        type=str,
        default='../method2_data/paths/noise.lst'
    )
    parser.add_argument(
        '--mix_list',
        type=str,
        default='../method2_data/paths/mix.lst'
    )
    parser.add_argument(
        '--generate_mix_wav',
        type=int,
    ...
    parser.add_argument(
        '--output_clean_dir',
        type=str,
        default='../method2_data/clean2'
    )
    parser.add_argument(
        '--output_noisy_dir',
        type=str,
        default='../method2_data/noisy'
    )
